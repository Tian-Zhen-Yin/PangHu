...
- [AI Agent 系统设计.md](./AI%20Agent%20系统设计.md) - V3.0 Agent 架构设计
...
| V3.0 | 2026-06-14 | Agent 框架重构，支持多工具编排，结构化卡片输出 |
| V4.0 | 2026-06-14 | 文档更新，补充 Agent 实现细节 |

---

_AI 顾问系统文档最后更新：2026-06-14_
